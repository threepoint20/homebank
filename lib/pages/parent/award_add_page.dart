...
class AwardAddPage extends StatelessWidget {
  AwardAddPage({Key key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              LargeButton(
                onTap: () async {
                  await showConfimationDialog(context);
                },
                title: "新增",
                fontSize: 16,
              ),
  ...
  showConfimationDialog(BuildContext context) {
    return showDialog(
